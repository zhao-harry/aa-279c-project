...
\lstinputlisting{src/getAlpha.m}
\lstinputlisting{src/reactionWheels.m}
\lstinputlisting{src/controlLaw.m}

\newpage
\subsection{Problem Set 10 – Momentum Management}
\lstinputlisting{src/ps10.m}
\lstinputlisting{src/getMagField.m}
\lstinputlisting{src/magnetorquer.m}