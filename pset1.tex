...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{Images/nisar_diagram.jpg}
...
For the RAB, we first model the geometry as a rectangular prism. We also must rotate the inertia tensor to match the orientation of the body axes.
...
A 3D model of the spacecraft is shown in Figure \ref{fig:simple_model}. The model shown is a screen capture from the SolidWorks CAD software.
