...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Images/ps2_problem9_p7.png}
\caption{Polhode and ellipsoids for angular velocity vector along first principal axis}
