...
For the energy ellipsoid, we compute our surface using rotational kinetic energy based on initial conditions and principal axes inertia.
...
Similarly, we compute our surface for the momentum ellipsoid with angular momentum.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Images/ps2_problem6.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Images/ps2_problem7.png}
