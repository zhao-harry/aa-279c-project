...
The three methods for attitude determination were implemented in three separate functions, shown below.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Images/ps6_problem6_1.png}
\caption{Error between target and actual attitude, with perturbations}
\label{fig:Images/ps6_problem3_error}
\end{figure}